...
theorem tsum_skip_of_deterministic (s : State Var) (inner : Program Var → StateRV Var) :
    (∑' cs : reachState Var,
    (programSmallStepSemantics [Prog| skip] s deterministic cs.prog cs.state) * inner cs.prog cs.state)
    = inner [Prog| ↓] s := by
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], s⟩, by simp⟩ : reachState Var)
      (fun cs => programSmallStepSemantics [Prog| skip] s deterministic cs.1.1 cs.1.2 * inner cs.1.1 cs.1.2)]
...
theorem tsum_assign_of_deterministic (s : State Var) (inner : Program Var → StateRV Var) :
    (∑' cs : reachState Var,
    (programSmallStepSemantics [Prog| v ≔ e] s deterministic cs.prog cs.state) * inner cs.prog cs.state)
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], (substituteStack s v (e s.stack))⟩, by simp⟩ : reachState Var)
      (fun cs => programSmallStepSemantics [Prog| v ≔ e] s deterministic cs.1.1 cs.1.2 * inner cs.1.1 cs.1.2)]
...
theorem tsum_mutate_of_deterministic (s : State Var) (inner : Program Var → StateRV Var)
    ...
    (∑' cs : reachState Var,
    (programSmallStepSemantics [Prog| e_loc *≔ e_val] s deterministic cs.prog cs.state) * inner cs.prog cs.state)
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], (substituteHeap s l (e_val s.stack))⟩, by simp⟩ : reachState Var)
      (fun cs => programSmallStepSemantics [Prog| e_loc *≔ e_val] s deterministic cs.1.1 cs.1.2 * inner cs.1.1 cs.1.2)]
...
theorem tsum_lookup_of_deterministic (s : State Var) (inner : Program Var → StateRV Var)
    ...
    (∑' cs : reachState Var,
    (programSmallStepSemantics [Prog| v ≔* e_loc] s deterministic cs.prog cs.state) * inner cs.prog cs.state)
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], (substituteStack s v value)⟩, by simp⟩ : reachState Var)
      (fun cs => programSmallStepSemantics [Prog| v ≔* e_loc] s deterministic cs.1.1 cs.1.2 * inner cs.1.1 cs.1.2)]
...
theorem tsum_cas_of_eq_of_deterministic (s : State Var) (inner : Program Var → StateRV Var)
    ...
    (∑' cs : reachState Var,
      (programSmallStepSemantics [Prog| v ≔ cas(e_loc, e_cmp, e_val)] s deterministic cs.prog cs.state)
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], (substituteStack (substituteHeap s l (e_val s.stack)) v 1)⟩,
      ...
      (fun cs => programSmallStepSemantics [Prog| v ≔ cas(e_loc, e_cmp, e_val)] s deterministic cs.1.1 cs.1.2
        * inner cs.1.1 cs.1.2)]
...
theorem tsum_alloc_of_allocation (s : State Var) (inner : Program Var → StateRV Var)
    ...
    (∑' cs : reachState Var,
      (programSmallStepSemantics [Prog| v ≔ alloc(e)] s (allocation l) cs.prog cs.state) * inner cs.prog cs.state)
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], (substituteStack (allocateHeap s l n) v l)⟩, by simp⟩ : reachState Var)
      (fun cs => programSmallStepSemantics [Prog| v ≔ alloc(e)] s (allocation l) cs.1.1 cs.1.2 * inner cs.1.1 cs.1.2)]
...
theorem tsum_alloc_of_deterministic_of_abort (s : State Var) (inner : Program Var → StateRV Var) :
    (∑' cs : reachState Var,
      (programSmallStepSemantics [Prog| v ≔ alloc(e)] s deterministic cs.prog cs.state) * inner cs.prog cs.state)
    = 0 := by
  rw[← tsum_subtype_eq_of_support_subset]
  pick_goal 2
  · apply mul_support_superset_left
...
theorem tsum_free_of_deterministic (s : State Var) (inner : Program Var → StateRV Var)
    ...
    (∑' cs : reachState Var,
      (programSmallStepSemantics [Prog| free(e_loc, e_val)] s deterministic cs.prog cs.state) * inner cs.prog cs.state)
  ...
  · rw [tsum_singleton (⟨⟨[Prog| ↓], (freeHeap s l n)⟩, by simp⟩ : reachState Var)
      (fun cs => programSmallStepSemantics [Prog| free(e_loc, e_val)] s deterministic cs.1.1 cs.1.2 * inner cs.1.1 cs.1.2)]
